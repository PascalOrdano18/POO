...
public class LoungeTester {
    public static void main(String[] args) {
       ...
       Salon lounge = new Salon(central, "Ezeiza Lounge");
        ...
        // de todas las aerolíneas que cuenten con al menos un pase cuando está abierto
        MSalon capLounge = new MSalon(central, 3, "The Centurion");
        ...
        MXSalon airLounge = new MXSalon(central, 4, "LATAM" ,"VIP Lounge");
