...
public class LoanTester {
    public static void main(String[] args) {
        ...
        Loan l1 = new Loan(1000, LocalDate.of(2022, 9, 1), 3, Destinatary.PERSONAL);
        ...
        // y las fechas de los mismos deben ser posteriores a la fecha del préstamo
        Loan l2 = new LoanLastInstallment(2000, LocalDate.of(2022, 9, 1), 3, Destinatary.VEHICLE);
        ...
        Loan l3 = new LoanSpecificDate(3000, LocalDate.of(2022, 9, 1), 3, Destinatary.HOME);
        ...
        try {
            ...
            new Loan(75000, LocalDate.of(2022, 9, 1), 3, Destinatary.PERSONAL);
        } catch (LoanException ex) {
        ...
        try {
            ...
            new Loan(1000, LocalDate.of(2022, 9, 1), 30, Destinatary.VEHICLE);
        } catch (LoanException ex) {
            System.out.println(ex.getMessage()); // Invalid Loan.
        }
    }
