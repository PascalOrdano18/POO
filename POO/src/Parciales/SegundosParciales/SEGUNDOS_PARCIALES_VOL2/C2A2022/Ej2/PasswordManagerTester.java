...
public class PasswordManagerTester {
    public static void main(String[] args) {
        ...
        passwordManager.addVault("Personal", Policies.NONE);
        ...
        passwordManager.addVault("Work", Policies.LEVEL1);
        ...
        // Si la bóveda no existe se arroja un error
        passwordManager.changeVaultPolicy("Work", Policies.LEVEL2);
        ...
        passwordManager.changeVaultPolicy("Personal", Policies.LEVEL1);
